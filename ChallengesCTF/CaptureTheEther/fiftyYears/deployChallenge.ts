...
async function main() {
  ...
  const hackGatekeeperContract = await (await ethers.getContractFactory("FiftyYearsChallenge")).connect(acct1).deploy(acct0.address,{ value: ethers.utils.parseEther("1")});
  // DEployed at: 0x5e4E68EcA47532c4F3337cf4a5aCe8E2210CAa98
